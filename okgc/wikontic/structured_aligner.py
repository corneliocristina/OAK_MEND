###############################################################################
#
# okgc/wikontic/structured_aligner.py
#
# Code originally from src/wikontic/utils/structured_aligned.py in
...
class Aligner:
    def __init__(self, ontology_db, triplets_db, sent_embed: SentenceEmbedder):
    ...
    def get_embedding(self, text):
        ...
        try:
            embeddings = self.sent_embed.encode(text)
