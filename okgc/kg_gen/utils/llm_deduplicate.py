###############################################################################
#
# okgc/kg_gen/utils/llm_deduplicate.py
#
# Code originally from src/kg_gen/utils/llm_deduplicate.py in
...
class LLMDeduplicate:
    ...
    def __init__(self, retrieval_model: SentenceTransformer, lm: dspy.LM, graph: Graph):
        ...
        self.node_embeddings = retrieval_model.encode(self.nodes)
        ...
        self.edge_embeddings = retrieval_model.encode(self.edges)
