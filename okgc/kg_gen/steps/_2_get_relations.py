###############################################################################
#
# okgc/kg_gen/steps/_2_get_relations.py
#
# Code originally from src/kg_gen/steps/_2_get_relations.py in
...
def _load_relations_prompt() -> str:
    ...
    prompt_path = os.path.join("prompts", "kg-gen", "relations.txt")
    return prompt_path
